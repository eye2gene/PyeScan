...
# From folder
anns = load_annotation_from_folder("/path/to/masks/",
...
from pyescan.visualise import (
    scan_summary, show_enface, show_oct, animate_oct,
    project_annotation_to_enface, draw_etdrs
)
...
result = run_on_dataframe(df, stat_name=["mask_pixel_count", "mask_area"],
