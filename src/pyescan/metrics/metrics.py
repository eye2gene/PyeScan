...
@pyescan_metric(
    ...
    returns=[
        "mask_pixel_count_slice_<quadrant>",
        "mask_pixel_count_projected_<quadrant>",
    ],
    parameters=["quadrant"],
)
...
@pyescan_metric(
    ...
    returns=[
        "mask_pixel_count_slice_<diameter>_mm",
        "mask_pixel_count_projected_<diameter>_mm",
    ],
    parameters=["diameter"],
)
...
def get_mask_area(
    ...
    mask_area = (
        mask_pixel_count * mask_resolutions_mm_width * mask_resolutions_mm_height
    )
...
def get_area_by_distance(
    ...
    mask_area = (
        pixel_count_region * mask_resolutions_mm_width * mask_resolutions_mm_height
    )
    return (mask_area,)
...
def get_volume_by_distance(
    ...
    volume = (
        pixel_count_region
        * mask_resolutions_mm_width
        * mask_resolutions_mm_height
        * resolutions_mm_depth
    )
