...
def get_results_from_dataframe(
    df, classes=None, group_on="file_path", patient_id_key="patient_number"
):
    import numpy as np
    ...
    if classes is None:
        classes = [
            ...
            if cls.startswith("pred_") and cls not in ["pred_class", "pred_model"]
        ]
