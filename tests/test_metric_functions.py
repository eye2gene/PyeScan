...
class TestMaskResolution:
    def test_same_size_as_scan(self):
        ...
        w, h = get_mask_resoluton(
            scan_width_px=512, scan_height_px=496,
            resolutions_mm_width=0.01, resolutions_mm_height=0.01,
            mask_width_px=512, mask_height_px=496,
        )
    ...
    def test_half_size_mask(self):
        ...
        w, h = get_mask_resoluton(
            scan_width_px=512, scan_height_px=496,
            resolutions_mm_width=0.01, resolutions_mm_height=0.01,
            mask_width_px=256, mask_height_px=248,
        )
...
class TestQuadrantMasksEnface:
    ...
    def test_centered_fovea_partitions_image(self):
        ...
        sup, dex, inf, sin = _get_quadrant_masks(
            mask_width_px=w, mask_height_px=h,
            fovea_enface_x=50, fovea_enface_y=50,
        )
    ...
    def test_off_center_fovea(self):
        ...
        sup, dex, inf, sin = _get_quadrant_masks(
            mask_width_px=w, mask_height_px=h,
            fovea_enface_x=25, fovea_enface_y=25,
        )
...
class TestDistanceMaskEnface:
    ...
    def test_centered_disk_area(self):
        ...
        mask, = _get_distance_mask(
            scan_width_px=100, resolutions_mm_width=0.01,
            resolutions_mm_height=0.01,
            mask_width_px=100, mask_height_px=100,
            fovea_enface_x=50, fovea_enface_y=50,
            diameter=0.5,
        )
    ...
    def test_disk_centered_on_fovea(self):
        ...
        mask, = _get_distance_mask(
            ...
            resolutions_mm_height=0.01,
            mask_width_px=100, mask_height_px=100,
            fovea_enface_x=30, fovea_enface_y=70,
            diameter=0.2,
        )
...
class TestCircleLineIntersection:
    ...
    def test_horizontal_line_through_center(self):
        ...
        t1, t2 = _get_circle_line_intersection(
            circle_centre=(5, 0), radius=2,
            line_start=(0, 0), line_end=(10, 0),
        )
    ...
    def test_no_intersection(self):
        ...
        result = _get_circle_line_intersection(
            circle_centre=(5, 5), radius=1,
            line_start=(0, 0), line_end=(10, 0),  # y=0, circle at y=5
        )
        assert result == []
    ...
    def test_tangent_line(self):
        ...
        t1, t2 = _get_circle_line_intersection(
            circle_centre=(5, 1), radius=1,
            line_start=(0, 0), line_end=(10, 0),  # y=0, circle at y=1
        )
...
class TestDistanceMaskSlice:
    ...
    def test_mask_shape_is_broadcastable(self):
        ...
        mask, = _get_distance_mask_slice(
            bscan_index=5, scan_width_px=100,
            resolutions_mm_width=0.01, resolutions_mm_depth=0.1,
            mask_width_px=200, mask_height_px=50,
            fovea_x=50, fovea_bscan_index=5, diameter=0.5,
        )
...
class TestQuadrantMasksSlice:
    ...
    def test_slice_mask_shape(self):
        ...
        sup, dex, inf, sin = _get_quadrant_masks_slice(
            bscan_location_start_x=0, bscan_location_start_y=50,
            bscan_location_end_x=100, bscan_location_end_y=50,
            mask_width_px=200, mask_height_px=50,
            fovea_enface_x=50, fovea_enface_y=50,
        )
        for q in [sup, dex, inf, sin]:
